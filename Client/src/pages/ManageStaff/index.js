...
const initialUsers = [
    { id: 1, name: 'John Doe', email: 'john.doe@example.com', role: 'Staff', status: 'Active' },
    { id: 2, name: 'Jane Smith', email: 'jane.smith@example.com', role: 'Staff', status: 'Active' },
    { id: 3, name: 'Michael Johnson', email: 'michael.johnson@example.com', role: 'Staff', status: 'Inactive' },
...
function ManageStaff() {
    ...
    return (
        <div className={cx('manage-user')}>
            <h2 className={cx('header')}>Manage Staff</h2>
            ...
            <div className={cx('add-user-form')}>
                <h3 className={cx('form-header')}>Add New Staff</h3>
