...
export const ShowTimeIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="currentColor"
        className={className}
        width={width}
    ...
    >
        ...
        ></path>
        <path fillRule="evenodd" clipRule="evenodd" d="m21.92 26.89 3.4-2.05.76-3.9-3.4 2.06-.76 3.89Z"></path>
    </svg>
);

export const ShowTimeActiveIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        fill="currentColor"
        className={className}
        width={width}
